...
//var element = possible_words[_random.nextInt(possible_words.length)];

//Iterable<WordPair> _generateWordPairs(
//    {Random random}) sync* {
//  random ??= _random;
//
//  List<String> possible_words;
//
//  String pickRandom(List<String> possible_words) => possible_words[_random.nextInt(possible_words.length)];
//
//  // We're in a sync* function, so `while (true)` is okay.
//  // ignore: literal_only_boolean_expressions
//
//  final prefix = pickRandom(possible_words);
//  final suffix = pickRandom(possible_words);
...
//      {Random random}) {
//    random ??= _random;
//    final pairsIterable = _generateWordPairs(
//        random: random);
